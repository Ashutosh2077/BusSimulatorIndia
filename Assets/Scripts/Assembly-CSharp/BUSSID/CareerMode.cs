...
namespace BUSSID
{
	public class CareerMode : GameModeBUSSID
	{
		public static CareerMode Instance;
		...
		public override bool IsCareer()
		{
			return false;
		}

		public static float CalculateRouteSegmentDistance(string from, string to)
		{
			return 0f;
		}
