Shader "BUSSID/GlassDecalDoubleSideMobileMOD" {
	Properties {
		_Color ("Color", Vector) = (1,1,1,1)
		_MainTex ("Texture", 2D) = "black" {}
		[Toggle(SPLIT_ALPHA_CHANNEL)] _SplitAlphaChannel ("Use separate alpha texture", Float) = 0
		...
		_ReflFresnel ("Refl fresnel", Range(0, 4)) = 1
