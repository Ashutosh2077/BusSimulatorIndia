Shader "BUSSID/Glowing Lamps Running Light" {
	Properties {
		_Color ("Main Color", Vector) = (1,1,1,1)
		_MainTex ("Texture", 2D) = "white" {}
		[NoScaleOffset] _GlowTex ("Glow map", 2D) = "white" {}
		_GlowStrength ("Glow strength", Float) = 1
		[PerRendererData] _glowTexMultiply ("Glow map multiply", Float) = 0
		_ReflStrength ("Refl strength", Range(0, 1)) = 0
		_ReflSmoothness ("Refl smoothness", Range(0, 1)) = 0
		...
		[PerRendererData] _RunningLightFill ("Running light fill", Range(0, 1)) = 0
