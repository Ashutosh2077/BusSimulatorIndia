Shader "BUSSID/Asphalt" {
	Properties {
		...
		[Toggle(SKIP_ROADLINES)] _SkipRoadLines ("Dont show road lines", Float) = 0
		[Toggle(SKIP_ASPHALTREPAIRS)] _SkipRepairs ("Dont show asphalt repairs", Float) = 0
